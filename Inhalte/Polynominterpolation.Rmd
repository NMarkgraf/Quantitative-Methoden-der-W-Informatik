...
Geraden stellt menschklassisch in der Form $f(x) = m \cdot x + b$ dar, wir können aber auch einen anderen Ansatz wählen:
...
Jedoch kann menschfür $f(x)= a_1 \cdot (x - x_0) + a_0$ die Koeffizienten 
...
Das *quadratische Polynom* (die *Parabel*) kann menschz.B. wie folgt auswerten:
...
Werden die einzelnen Stützpunkte mit Geraden verbunden spricht menschvon einer
