...
- *Addition*:
    - absoluter Fehler: $\displaystyle \left|(\tilde{x} + \tilde{y}) - (x + y)\right| =  \left|- (e_x \cdot x + e_y \cdot y)\right|$
    - relativer Fehler: $\displaystyle \left|\frac{(x+y) - (\tilde{x}+\tilde{y})}{x + y}\right| = \left|\frac{x}{x+y}\cdot e_x + \frac{y}{x+y}\cdot e_y\right|$
