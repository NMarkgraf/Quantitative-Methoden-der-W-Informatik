...
\end{itemize}
\vspace{0.5cm}
\scriptsize -- \href[https://de.wikipedia.org/wiki/Karl_Nickel]{Professor Karl Nickel} (Informatikpionier der Universität Karlsruhe)  
\end{quote} 
...
richtig wäre $`python 0.000000000001`$!
...
Bisher haben wir den Exponenten in 2 Bits gespeichert und damit 3 Zahlen (-1, 0 und 1), dargestellt. In 2 Bits können aber 4 Werte kodiert werden (z.B.: 0,1,2,3).

Das liegt daran, das wir ein Bit zum Kodieren des Vorzeichens benutzt haben. Dieses Bit können wir einsparen, wenn wir noch eine Verschiebung (engl. *bias*) festlegen. 

Der wahre Exponent $e$ ergibt sich dann aus der Kodierung $E$ Minus der Verschiebung $bias$:

$$e = E - bias$$

Wir wählen für unser Beispiel einen Biaswert von $2$ und haben somit die vier möglichen Exponenten $-2, -1, 0, 1$.
