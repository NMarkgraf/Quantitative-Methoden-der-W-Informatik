...
::: {.notes}
Zu unserem bisherigen Beispiel kommen die folgenden acht normalisierten Zahlen kommen hinzu:

$-(0.100) \cdot 2^{-2}; -(0.101) \cdot 2^{-1}; -(0.110) \cdot 2^{-1}; -(0.111) \cdot 2^{-1}$

$+(0.100) \cdot 2^{-2}; +(0.101) \cdot 2^{-2}; +(0.110) \cdot 2^{-2}; +(0.111) \cdot 2^{-2};$

Ebenfalls die sechs nicht-normalisierten Zahlen:

$\pm(0.010) \cdot 2^{-2}; \pm(0.001) \cdot 2^{-2}; \pm(0.011) \cdot 2^{-2};$

Sowie die *exotische Nullen* der Form $\pm(0.000) \cdot 2^{-2}$.

Wir haben somit 24+8=32 normalisierte Gleitpunktzahlen, 18+6=24 nicht-normalisierte Gleitpunktzahlen und 4+2=6 *exotische* Nullen und eine (normale) Null und eine *negative* Null. Insgesamt haben wir so in den 6 Bits platz für $64 = 2^6$ mögliche Zahlen. Einige davon stellen den selben Wert da und können daher als Kodierungen für *besondere Zustände*, wie Über- oder Unterlauf, postives/negatives "Unendlich" verwendet werden.
