...
Wo liegt, ausgehend von $x_0=2$, die Break-Even ($x_{BE}$) Gewinnschwelle?  -- Geben Sie eine Näherung mit Hilfe des Newtonverfahrens ($epsilon=0.0000001$) an! Erstellen Sie dafür eine Tablle mit $i, x_i, f(x_i), f'(x_i)$.
...
newton(2, fkt, dfkt, epsilon=0.0000001)
```
:::
